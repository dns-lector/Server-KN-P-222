...
# Задачі:
# - перевірити чи перша літера прізвища є великою
# - перевірити, що подальші літери імені та прізвища є маленькими
# - дозволити складені прізвища та імена через тире: Усова-Макаренко, Жан-Поль
#    для них правила повторюються - перша літера велика, інші маленькі по кожній групі
# - додати позитивний стиль валідації (is-valid) за умови наявності та правильності даних